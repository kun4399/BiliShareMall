...
export namespace scrapy {
	...
	export class MonitorConfig {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.rules = this.convertValues(source["rules"], MonitorRule);
	    }
	...
	export class MonitorHitItem {
	    ...
	    static createFrom(source: any = {}) {
	        return new MonitorHitItem(source);
	    }
	...
	export class MonitorHitGroup {
	    ruleId: number;
	    hits: MonitorHitItem[];
	
	    static createFrom(source: any = {}) {
	        return new MonitorHitGroup(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.ruleId = source["ruleId"];
	        this.hits = this.convertValues(source["hits"], MonitorHitItem);
	    }
